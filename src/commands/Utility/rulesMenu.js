                ...
                try {
                    ...
                    if (btnInteraction.customId === 'rules_basic') {
                        const basicRulesEmbed = createEmbed({
                            ...
                            fields: [
                                { name: ':scales: R1 No naked killing', value: '⏱️ **3h ban**', inline: true },
                                { name: ':scales: R2 No spawn camping', value: '⏱️ **5h ban**', inline: true },
                                { name: ':scales: R3 Lag machine', value: '⏱️ **3 days ban**', inline: true },
                                { name: ':scales: R4 Wither spawning', value: '⏱️ **1 day ban** (At Spawn)', inline: true },
                                { name: ':scales: R5 Chat rules', value: '⏱️ **2h ban**', inline: true },
                                { name: ':scales: R6 No Stasis Chambers', value: '⏱️ **3h ban** (In Combat)', inline: true },
                                { name: ':scales: R7 Pushing out of spawn', value: '⏱️ **5h ban**', inline: true },
                                { name: ':scales: R8 No elytra in combat', value: '⏱️ **4h ban**', inline: true },
                                { name: ':scales: R9 Noobie protection', value: '⏱️ **2h ban** (Abuse)', inline: true },
                                { name: ':scales: R10 Instant damage arrows', value: '⏱️ **3h ban**', inline: true },
                                { name: ':scales: R11 No crystals', value: '⏱️ **5h ban**', inline: true },
                                { name: ':scales: R12 String drop at spawn', value: '⏱️ **1h ban**', inline: true },
                                { name: ':scales: R13 No trident in combat', value: '⏱️ **4h ban**', inline: true },
                                { name: ':scales: R14 Toxicity', value: '⏱️ **3h ban**', inline: true },
                                { name: ':scales: R15 Excessive swearing', value: '⏱️ **1 day ban** (Chat Flood)', inline: true },
                                { name: ':scales: R16 English only', value: '⏱️ **2h ban**', inline: true },
                                { name: ':scales: R17 Advertising servers', value: '⏱️ **4h ban**', inline: true },
                                { name: ':scales: R18 Ticket spam', value: '⏱️ **7h ban**', inline: true },
                                { name: ':scales: R19 Incorrect team size', value: '⏱️ *Staff review*', inline: true },
                                { name: ':scales: R20 Duping/Cheating', value: '⏱️ **7 days ban**', inline: true },
                                { name: ':scales: R21 Staff Respect / Moderation', value: '⏱️ **6h ban** (Arguing with staff or about mod decisions)', inline: false },
                            ],
